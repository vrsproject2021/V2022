<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSAbnormalRptReasons.aspx.cs" Inherits="VETRIS.Settings.VRSAbnormalRptReasons" %>
...
<head runat="server">
    ...
    <script src="scripts/AbnormalRptReasonsHdr.js"></script>
</head>
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-select-list">
                                    ...
                                    <asp:TextBox ID="txtReason" runat="server" CssClass="form-control" MaxLength="250"></asp:TextBox>
                                    ...
                                    <ComponentArt:Grid
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="reason" Align="left" HeadingText="Name" AllowGrouping="false" DataCellClientTemplateId="REASON" FixedWidth="True" Width="700" />
                                        ...
                                        <ClientTemplates>
                                            ...
                                            <ComponentArt:ClientTemplate ID="REASON">
                                                <input type="text" id="txtReason_## DataItem.GetMember('rec_id').Value ##" class="GridTextBox" value="## DataItem.GetMember('reason').Value ##" maxlength="250" style="width: 100%;" onchange="javascript:txtReason_OnChange('## DataItem.GetMember('rec_id').Value ##');" />
...
<script type="text/javascript">
    ...
    var strForm = "VRSAbnormalRptReasons";

</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="../scripts/AppPages.js"></script>
<script src="scripts/AbnormalRptReasons.js"></script>
</html>

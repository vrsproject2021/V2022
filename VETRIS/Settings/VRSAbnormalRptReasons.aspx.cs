...
{
    [AjaxPro.AjaxNamespace("VRSAbnormalRptReasons")]
    public partial class VRSAbnormalRptReasons : System.Web.UI.Page
    {
        #region Members & Variables
        VETRIS.Core.Settings.AbnormalRptReasons objCore = null;
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSAbnormalRptReasons));
            SetAttributes();
        ...
        {
            objCore = new Core.Settings.AbnormalRptReasons();
        ...
        public string[] SaveRecord(string[] ArrRecord, string[] ArrParams)
        {
            ...
            objCore = new Core.Settings.AbnormalRptReasons();
            int intListIndex = 0;
            Core.Settings.AbnormalRptReasons[] objRecords = new Core.Settings.AbnormalRptReasons[0];
            ...
            try
            {
                ...
                objRecords = new Core.Settings.AbnormalRptReasons[(ArrRecord.Length / 4)];

                for (int i = 0; i < objRecords.Length; i++)
                {
                    objRecords[i] = new Core.Settings.AbnormalRptReasons();

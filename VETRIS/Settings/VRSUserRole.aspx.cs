...
{
    [AjaxPro.AjaxNamespace("VRSUserRole")]
    public partial class VRSUserRole : System.Web.UI.Page
    {
        #region Members & Variables
        VETRIS.Core.Settings.UserRole objCore = null;
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSUserRole));
            SetAttributes();
        ...
        {
            objCore = new Core.Settings.UserRole();
        ...
        public string[] SaveRecord(string[] ArrRecord, string[] ArrParams)
        {
            ...
            objCore = new Core.Settings.UserRole();
            int intListIndex = 0;
            Core.Settings.UserRole[] objRecords = new Core.Settings.UserRole[0];
            ...
            try
            {
                ...
                objRecords = new Core.Settings.UserRole[(ArrRecord.Length/5)];

                for (int i = 0; i < objRecords.Length;i++)
                {
                    objRecords[i] = new Core.Settings.UserRole();

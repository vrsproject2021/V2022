...
namespace VETRIS.AP
{
    [AjaxPro.AjaxNamespace("VRSAdhocPmtHeads")]
    public partial class VRSAdhocPmtHeads : System.Web.UI.Page
    {
        #region Members & Variables
        VETRIS.Core.AP.AdhocPaymentHead objCore = null;
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSAdhocPmtHeads));
            SetAttributes();
        ...
        {
            objCore = new Core.AP.AdhocPaymentHead();
        ...
        public string[] SaveRecord(string[] ArrRecord, string[] ArrParams)
        {
            ...
            objCore = new Core.AP.AdhocPaymentHead();
            int intListIndex = 0;
            Core.AP.AdhocPaymentHead[] objRecords = new Core.AP.AdhocPaymentHead[0];
            ...
            try
            {
                ...
                objRecords = new Core.AP.AdhocPaymentHead[(ArrRecord.Length / 5)];

                for (int i = 0; i < objRecords.Length; i++)
                {
                    objRecords[i] = new Core.AP.AdhocPaymentHead();

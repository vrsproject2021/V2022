...
function SearchRecord() {
    ...
    ArrRecords[1] = objtxtPatientID.value;
    ArrRecords[2] = objddlInstitution.value;
    ArrRecords[3] = "N"; if (chkStudyDt.checked) ArrRecords[2] = "Y";
    ArrRecords[4] = strDtFrom;
    ArrRecords[5] = strDtTill;
    ArrRecords[6] = objtxtStudyUID.value;
    ArrRecords[7] = objddlStatus.value;
    ArrRecords[8] = UserID;
    ArrRecords[9] = UserRoleID
...
function ResetRecord() {
    ...
    objtxtPatientID.value = "";
    chkStudyDt.checked = false;

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSDCMStudyBrw.aspx.cs" Inherits="VETRIS.Study.VRSDCMStudyBrw" %>
...
<head runat="server">
    ...
    <script src="scripts/DCMStudyBrwHdr.js"></script>
</head>
<body>
                ...
                <div class="sparkline10-hd">
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <h2>Studies Received With DCM Image</h2>
                        </div>
...
<script type="text/javascript">
    ...
    var strForm = "VRSDCMStudyBrw";

</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="../scripts/AppPages.js"></script>
<script src="scripts/DCMStudyBrw.js"></script>
</html>

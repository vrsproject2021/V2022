...
{
    [AjaxPro.AjaxNamespace("VRSPaymentProcess")]
    public partial class VRSPaymentProcess : System.Web.UI.Page
    {
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSPaymentProcess));
        ...
        private void SetAttributes()
        {
            ...
            btnAdd.Attributes.Add("onclick", "javascript:btnBrwAddUI_Onclick('Invoicing/VRSOfflinePaymentDlg.aspx');");
        ...
        private void SearchRecord(string[] arrRecord)
        {
            ...
            try
            {
                ...
                objCore.payment_mode = arrRecord[1].Trim();
                ...
                objCore.FromDate = Convert.ToDateTime(arrRecord[5]);
                objCore.ToDate = Convert.ToDateTime(arrRecord[6]);
                objCore.PaymentRef = Convert.ToString(arrRecord[7]);
                objCore.ExternalPaymentRef = Convert.ToString(arrRecord[8]);

...
<head runat="server">
    ...
    <script src="scripts/PromotionBrwHdr.js?v=<%=DateTime.Now.Ticks%>"></script>
</head>
<body>
                            ...
                            <div class="col-sm-2 col-xs-12">
                                <div class="form-select-list">
                                    ...
                                    <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control custom-select-value">
                                        ...
                                        <asp:ListItem Value="C" Text="Cash Discounts Only"></asp:ListItem>
                                        <asp:ListItem Value="D" Text="Discount % Only"></asp:ListItem>
...
<script src="scripts/PromotionBrw.js?v=<%=DateTime.Now.Ticks%>"></script>
</html>

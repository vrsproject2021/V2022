<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSOnlinePmtReconcile.aspx.cs" Inherits="VETRIS.Invoicing.VRSOnlinePmtReconcile" %>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <div class="pull-left marginTP10">
                                <h3 style="color: #1e77bb;">Filter By</h3>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            &nbsp;
            ...
            <div class="sparkline10-list mt-b-10" id="pmtDiv" runat="server">
                <div class="searchSection">
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <div class="pull-left marginTP10">
                                <h3 style="color: #1e77bb;">Transactions</h3>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-6">
                                            ...
                                            <Levels>
                                                <ComponentArt:GridLevel AllowGrouping="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <ComponentArt:GridColumn DataField="refundref_no" Align="left" HeadingText="Refund Ref#" AllowGrouping="false" Width="100" />
                                                        ...
                                                        <ComponentArt:GridColumn DataField="payment_amount" Align="right" HeadingText="Charged Amount ($)" AllowGrouping="false" Width="120" FormatString="#0.00" />
                                                        <ComponentArt:GridColumn DataField="refund_amount" Align="right" HeadingText="Refund Amount ($)" AllowGrouping="false" Width="120" FormatString="#0.00" />
                                                        ...
                                                        <ComponentArt:GridColumn DataField="effected_date_time" Align="left" HeadingText="Effected Date / Time" AllowGrouping="false" Width="80" />
                                                        <ComponentArt:GridColumn DataField="transaction_amount" Align="right" HeadingText="Realized Amount ($)" AllowGrouping="false" FormatString="#0.00" Width="120" />
                                                        <ComponentArt:GridColumn DataField="difference_amount" Align="right" HeadingText="Difference ($)" AllowGrouping="false" FormatString="#0.00" Width="80" />
...
<script type="text/javascript">
    ...
    var strForm = "VRSReconcilation";


</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="../scripts/AppPages.js"></script>
<script src="scripts/PaymentReconcilation.js?v=<%=DateTime.Now.Ticks%>"></script>
</html>

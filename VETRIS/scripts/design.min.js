...
function init_chart_doughnut() {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var a = {
            ...
            data: {
                labels: [" In Process", "Extended", "Done", "Future"],
                datasets: [{
                    data: [11, 8, 8, 2],
                    backgroundColor: ["#ff9702", "#e74c3c", "#48cfae", "#3498db"],
                    hoverBackgroundColor: ["#fe9c0f", "#f73825", "#11deac", "#14a1ff"]
                }]
            },
            options: {
                legend: !1,
...
function init_chart_doughnut2() {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut2").length)) {
        var a = {
            type: "doughnut",
            tooltipFillColor: "rgba(51, 51, 51, 0.55)",
            data: {
...
function init_gauge() {
    if ("undefined" != typeof Gauge) {
        ...
        if ($("#gauge-text").length && (c.maxValue = 100, c.animationSpeed = 32, c.set(55), c.setTextField(document.getElementById("gauge-text"))), $("#chart_gauge_02").length) var d = document.getElementById("chart_gauge_02"),
            e = new Gauge(d).setOptions(a);
        $("#gauge-text2").length && (e.maxValue = 100, e.animationSpeed = 32, e.set(1), e.setTextField(document.getElementById("gauge-text2")))
    }
}

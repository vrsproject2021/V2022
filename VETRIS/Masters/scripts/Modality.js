...
function btnSave_OnClick() {
    ...
    try {
        ...
        VRSModality.SaveRecord(ArrRecords, arrParams, ShowProcess);
...
function GetRecords() {
    ...
    while (gridItem = grdBrw.get_table().getRow(itemIndex)) {
        ...
        if (changed == "Y") {
            ...
            arrRecords[idx + 7] = gridItem.Data[7].toString();
            arrRecords[idx + 8] = gridItem.Data[8].toString();
            idx = idx + 9;
        }
        itemIndex++;
    }
...
function txtTag_OnChange(ID) {
    var itemIndex = 0; var gridItem; var RowId = "0";
    while (gridItem = grdBrw.get_table().getRow(itemIndex)) {
        RowId = gridItem.Data[0].toString();

        if (RowId == ID) {
            gridItem.Data[4] = document.getElementById("txtTag_" + RowId).value;
            gridItem.Data[9] = "Y";
            break;
        }
        itemIndex++;
...
function ddlTrack_OnChange(ID) {
    var itemIndex = 0; var gridItem; var RowId = "0";
    while (gridItem = grdBrw.get_table().getRow(itemIndex)) {
        RowId = gridItem.Data[0].toString();

        if (RowId == ID) {
            gridItem.Data[5] = document.getElementById("ddlTrack_" + RowId).value;
            gridItem.Data[9] = "Y";
            break;
        }
        itemIndex++;
...
function ddlInvoice_OnChange(ID) {
    var itemIndex = 0; var gridItem; var RowId = "0";
    while (gridItem = grdBrw.get_table().getRow(itemIndex)) {
        RowId = gridItem.Data[0].toString();

        if (RowId == ID) {
            gridItem.Data[6] = document.getElementById("ddlInvoice_" + RowId).value;
            gridItem.Data[9] = "Y";
            break;
        }
        itemIndex++;
...
function txtFilePath_OnChange(ID) {
    var itemIndex = 0; var gridItem; var RowId = "0";
    while (gridItem = grdBrw.get_table().getRow(itemIndex)) {
        RowId = gridItem.Data[0].toString();

        if (RowId == ID) {
            gridItem.Data[7] = document.getElementById("txtFilePath_" + RowId).value;
            gridItem.Data[9] = "Y";
            break;
        }
        itemIndex++;
...
function GetGridDetails() {
    ...
    while (gridItem = grdBrw.get_table().getRow(itemIndex)) {
        ...
        strDtls += gridItem.Data[9].toString();
        itemIndex++;
    }
    return strDtls;
}

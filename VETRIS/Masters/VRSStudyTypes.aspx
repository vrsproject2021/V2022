<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSStudyTypes.aspx.cs" Inherits="VETRIS.Masters.VRSStudyTypes" %>
...
<head runat="server">
    ...
    <script src="scripts/StudyTypesHdr.js?11022020"></script>
    <title></title>
</head>
<body>
    <form id="form1" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label" for="username">Modality</label>
                                    ...
                                    <ComponentArt:Grid
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="name" Align="left" HeadingText="Name" AllowGrouping="false" DataCellClientTemplateId="NAME" FixedWidth="True" Width="250" />
                                                    <ComponentArt:GridColumn DataField="modality_id" Align="left" HeadingText="Modality" AllowGrouping="true" DataCellClientTemplateId="MODALITY" FixedWidth="True" Width="240" />
                                                    <ComponentArt:GridColumn DataField="category_id" Align="left" HeadingText="Category" AllowGrouping="true" DataCellClientTemplateId="CATEGORY" FixedWidth="True" Width="150" />
                                                    <ComponentArt:GridColumn DataField="validate_study_count" Align="center" HeadingText="Validate Study Count" AllowGrouping="false" DataCellClientTemplateId="VALIDATE" FixedWidth="True" Width="130" />
                                        ...
                                        <ClientTemplates>
                                            ...
                                            <ComponentArt:ClientTemplate ID="NAME">
                                                <input type="text" id="txtName_## DataItem.GetMember('rec_id').Value ##" class="GridTextBox" value="## DataItem.GetMember('name').Value ##" maxlength="50" style="width: 95%;" onchange="javascript:txtName_OnChange('## DataItem.GetMember('rec_id').Value ##');" />
                                            </ComponentArt:ClientTemplate>
                                            <ComponentArt:ClientTemplate ID="MODALITY">
                                                <select id="ddlModality_## DataItem.GetMember('rec_id').Value ##" class="form-control custom-select-value" style="width: 99%;" onchange="javascript:ddlModality_OnChange('## DataItem.GetMember('rec_id').Value ##');">
                                                </select>

                                            </ComponentArt:ClientTemplate>
                                            <ComponentArt:ClientTemplate ID="CATEGORY">
                                                <select id="ddlCategory_## DataItem.GetMember('rec_id').Value ##" class="form-control custom-select-value" style="width: 99%;" onchange="javascript:ddlCategory_OnChange('## DataItem.GetMember('rec_id').Value ##');">
                                                </select>

                                            </ComponentArt:ClientTemplate>
                                             <ComponentArt:ClientTemplate ID="VALIDATE">
                                                <div class="grid_option">
                                                    <input type="checkbox" id="chkValid_## DataItem.GetMember('rec_id').Value ##" style="width: 18px; height: 18px;" onclick="javascript:ChkValid_OnClick('## DataItem.GetMember('rec_id').Value ##');" />
                                                </div>
        ...
        <input type="hidden" id="hdnModalities" runat="server" value="" />
...
<script type="text/javascript">
    ...
    var objhdnModalities = document.getElementById('<%=hdnModalities.ClientID %>');
...
<script src="scripts/StudyTypes.js?11022020"></script>
</html>

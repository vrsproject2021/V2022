<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSServices.aspx.cs" Inherits="VETRIS.Masters.VRSServices" %>
...
<head runat="server">
    ...
    <script src="scripts/ServicesHdr.js?11012021"></script>
</head>
<body>
    <form id="form1" runat="server">
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <ComponentArt:Grid
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="name" Align="left" HeadingText="Name" AllowGrouping="false" DataCellClientTemplateId="NAME" FixedWidth="True" Width="200" />
                                                    <ComponentArt:GridColumn DataField="code" Align="left" HeadingText="PACS Code" AllowGrouping="false" DataCellClientTemplateId="CODE" FixedWidth="True" Width="100" />
                                                    <ComponentArt:GridColumn DataField="priority_id" Align="left" HeadingText="Linked to priority" AllowGrouping="false" DataCellClientTemplateId="PRIORITY" FixedWidth="True" Width="150" />
                                                     <ComponentArt:GridColumn DataField="gl_code" Align="left" HeadingText="G/L Code" AllowGrouping="false" DataCellClientTemplateId="GL" FixedWidth="True" Width="100" Visible="false" />
                                                    <ComponentArt:GridColumn DataField="is_active" Align="center" HeadingText="Active" AllowGrouping="false" DataCellClientTemplateId="STATUS" FixedWidth="True" Width="50" />
                                                    <ComponentArt:GridColumn DataField="changed" Align="left" HeadingText="changed" AllowGrouping="false" Visible="false" />
                                                    <ComponentArt:GridColumn DataField="sys_defined" Align="left" HeadingText="sys_defined" AllowGrouping="false" Visible="false" />
                                        ...
                                        <ClientTemplates>
                                           ...
                                           <ComponentArt:ClientTemplate ID="CODE">
                                                <input type="text" id="txtCode_## DataItem.GetMember('rec_id').Value ##" class="GridTextBox" value="## DataItem.GetMember('code').Value ##" maxlength="10" style="width:90%;text-transform:uppercase;" onchange="javascript:txtCode_OnChange('## DataItem.GetMember('rec_id').Value ##');" />
                                            </ComponentArt:ClientTemplate>
                                            <ComponentArt:ClientTemplate ID="PRIORITY">
                                                <select id="ddlPriority_## DataItem.GetMember('rec_id').Value ##" class="form-control custom-select-value" style="width: 99%;" onchange="javascript:ddlPriority_OnChange('## DataItem.GetMember('rec_id').Value ##');">
                                                </select>
                                            </ComponentArt:ClientTemplate>
                                             <ComponentArt:ClientTemplate ID="GL">
                                                <input type="text" id="txtGLCode_## DataItem.GetMember('rec_id').Value ##" class="GridTextBox" value="## DataItem.GetMember('gl_code').Value ##" maxlength="5" style="width:90%;padding-left:5px;" onchange="javascript:txtGLCode_OnChange('## DataItem.GetMember('rec_id').Value ##');" />
                                            </ComponentArt:ClientTemplate>
        ...
        <input type="hidden" id="hdnID" runat="server" value="0" />
         <input type="hidden" id="hdnPriorities" runat="server" value="" />
    </form>
</body>
<script type="text/javascript">
    var objhdnID = document.getElementById('<%=hdnID.ClientID %>');
    var objhdnError = document.getElementById('<%=hdnError.ClientID %>');
    var objhdnPriorities = document.getElementById('<%=hdnPriorities.ClientID %>');
    var objtxtName = document.getElementById('<%=txtName.ClientID %>');
    var objddlStatus = document.getElementById('<%=ddlStatus.ClientID %>');
    var strForm = "VRSServices";

</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="../scripts/AppPages.js"></script>
<script src="scripts/Services.js?12012021"></script>
</html>

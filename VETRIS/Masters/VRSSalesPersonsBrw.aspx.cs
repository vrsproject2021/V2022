...
{
    [AjaxPro.AjaxNamespace("VRSSalesPersonsBrw")]
    public partial class VRSSalesPersonsBrw : System.Web.UI.Page
    {
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSSalesPersonsBrw));
        ...
        {
            btnAdd.Attributes.Add("onclick", "javascript:btnBrwAddUI_Onclick('Masters/VRSSalesPersonDlg.aspx');");

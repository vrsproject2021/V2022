...
<head runat="server">
   ...
   <link id="lnkGRID" runat="server" href = "../css/grid_style.css" rel="stylesheet" type="text/css" />
    ...
    <script src="scripts/ModalityHdr.js?01022021"></script>
</head>
<body>
                                    ...
                                    <ComponentArt:Grid
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="code" Align="left" HeadingText="Code" AllowGrouping="false" DataCellClientTemplateId="CODE" FixedWidth="True" Width="80"/>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="track_by" Align="left" HeadingText="Track Records By" AllowGrouping="false" DataCellClientTemplateId="TRACK" FixedWidth="True" Width="130" />
                                                    <ComponentArt:GridColumn DataField="invoice_by" Align="left" HeadingText="Invoicing By" AllowGrouping="false" DataCellClientTemplateId="INVOICE" FixedWidth="True" Width="150"/>
                                                    <ComponentArt:GridColumn DataField="file_receive_path" Align="left" HeadingText="File Receiving Path" AllowGrouping="false" DataCellClientTemplateId="FILEPATH" FixedWidth="True" Width="200"/>
                                                     <ComponentArt:GridColumn DataField="is_active" Align="center" HeadingText="Active" AllowGrouping="false" DataCellClientTemplateId="STATUS" FixedWidth="True" Width="80" />
                                        ...
                                        <ClientTemplates>
                                            ...
                                            <ComponentArt:ClientTemplate ID="NAME">
                                                <input type="text" id="txtName_## DataItem.GetMember('rec_id').Value ##" class="GridTextBox" value="## DataItem.GetMember('name').Value ##" maxlength="50" style="width:99%;" onchange="javascript:txtName_OnChange('## DataItem.GetMember('rec_id').Value ##');" />
                                            </ComponentArt:ClientTemplate>
                                            <ComponentArt:ClientTemplate ID="TAG">
                                             ...
                                             <ComponentArt:ClientTemplate ID="TRACK">
                                                <select id="ddlTrack_## DataItem.GetMember('rec_id').Value ##" class="form-control custom-select-value" style="width: 99%;" onchange="javascript:ddlTrack_OnChange('## DataItem.GetMember('rec_id').Value ##');">
                                                    <option value="I">Image Count</option>
                                                    <option value="O">Object Count</option>
                                                </select>
                                            </ComponentArt:ClientTemplate>
                                             <ComponentArt:ClientTemplate ID="INVOICE">
                                                <select id="ddlInvoice_## DataItem.GetMember('rec_id').Value ##" class="form-control custom-select-value" style="width: 99%;" onchange="javascript:ddlInvoice_OnChange('## DataItem.GetMember('rec_id').Value ##');">
                                                    <option value="B">Body Part Count</option>
                                                    <option value="I">Image Count</option>
                                                    <option value="M">Minute Count</option>
                                                </select>
                                            </ComponentArt:ClientTemplate>
                                            <ComponentArt:ClientTemplate ID="FILEPATH">
                                                <input type="text" id="txtFilePath_## DataItem.GetMember('rec_id').Value ##" class="GridTextBox" value="## DataItem.GetMember('file_receive_path').Value ##" maxlength="250" style="width:90%;" onchange="javascript:txtFilePath_OnChange('## DataItem.GetMember('rec_id').Value ##');" />
                                            </ComponentArt:ClientTemplate>
...
<script src="../scripts/AppPages.js?01022021"></script>
<script src="scripts/Modality.js?01022021"></script>
</html>

...
{
    [AjaxPro.AjaxNamespace("VRSTechnicianBrw")]
    public partial class VRSTechnicianBrw : System.Web.UI.Page
    {
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSTechnicianBrw));
        ...
        {
            btnAdd.Attributes.Add("onclick", "javascript:btnBrwAddUI_Onclick('Masters/VRSTechnicianDlg.aspx');");

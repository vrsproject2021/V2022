...
{
     [AjaxPro.AjaxNamespace("VRSPhysicianBrw")]
    public partial class VRSPhysicianBrw : System.Web.UI.Page
    {
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSPhysicianBrw));
        ...
        {
            btnAdd.Attributes.Add("onclick", "javascript:btnBrwAddUI_Onclick('Masters/VRSPhysicianDlg.aspx');");

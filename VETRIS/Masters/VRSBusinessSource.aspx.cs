...
{
    [AjaxPro.AjaxNamespace("VRSBusinessSource")]
    public partial class VRSBusinessSource : System.Web.UI.Page
    {
        #region Members & Variables
        VETRIS.Core.Master.BusinessSources objCore = null;
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSBusinessSource));
            SetAttributes();
        ...
        {
            objCore = new Core.Master.BusinessSources();
        ...
        public string[] SaveRecord(string[] ArrRecord, string[] ArrParams)
        {
            ...
            objCore = new Core.Master.BusinessSources();
            int intListIndex = 0;
            Core.Master.BusinessSources[] objRecords = new Core.Master.BusinessSources[0];
            ...
            try
            {
                ...
                objRecords = new Core.Master.BusinessSources[(ArrRecord.Length / 4)];

                for (int i = 0; i < objRecords.Length; i++)
                {
                    objRecords[i] = new Core.Master.BusinessSources();

...
{
    [AjaxPro.AjaxNamespace("VRSTransciptionistBrw")]
    public partial class VRSTransciptionistBrw : System.Web.UI.Page
    {
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSTransciptionistBrw));
        ...
        {
            btnAdd.Attributes.Add("onclick", "javascript:btnBrwAddUI_Onclick('Masters/VRSTransciptionistDlg.aspx');");

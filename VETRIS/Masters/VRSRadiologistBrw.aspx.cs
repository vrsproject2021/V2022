...
{
    [AjaxPro.AjaxNamespace("VRSRadiologistBrw")]
    public partial class VRSRadiologistBrw : System.Web.UI.Page
    {
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSRadiologistBrw));
        ...
        {
            btnAdd.Attributes.Add("onclick", "javascript:btnBrwAddUI_Onclick('Masters/VRSRadiologistDlg.aspx');");
        ...
        private void FetchSearchParameters()
        {
            ...
            try
            {
                ...
                if (bReturn)
                {
                    ...
                    #region Time Zone
                    DataRow dr2 = ds.Tables["TimeZone"].NewRow();
                    dr2["id"] = 0;
                    dr2["name"] = "Select One";
                    ds.Tables["TimeZone"].Rows.InsertAt(dr2, 0);
                    ...
                    #region Group
                    DataRow dr3 = ds.Tables["Group"].NewRow();
                    dr3["id"] = 0;
                    dr3["name"] = "Select One";
                    ds.Tables["Group"].Rows.InsertAt(dr3, 0);
                    ds.Tables["Group"].AcceptChanges();

                    ddlGroup.DataSource = ds.Tables["Group"];
        ...
        private void SearchRecord(string[] arrRecord)
        {
            ...
            try
            {
                ...
                objCore.ACCOUNT_GROUP_ID = Convert.ToInt32(arrRecord[5]);
                objCore.MOBILE = arrRecord[6].Trim();
                objCore.TIME_ZONE_ID = Convert.ToInt32(arrRecord[7]);

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSModalityRevenue.aspx.cs" Inherits="VETRIS.Dashboard.ModalityRevenue.VRSModalityRevenue" %>
        ...
        <header style="margin-top: 5px;">
            <div class="form-inline mt-2">
                <div class="form-group">
                    <label for="last_month">Months:</label>
                    <select id="last_month" style="padding: 2px 4px; width: 220px;" class="form-control">
...
<script src="../scripts/monthly-revenue.js?t=<%=DateTime.Now.Ticks%>"></script>
</html>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSHourlyCompletedCases.aspx.cs" Inherits="VETRIS.Dashboard.HourlyCompletedCases.VRSHourlyCompletedCases" %>
        ...
        <header style="margin-top: 5px;">
            <div class="form-inline mt-2">
                ...
                <div class="form-group">
                    ...
                    <select id="tp" style="padding: 2px 4px; width: 220px;" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <%--<select id="md" style="padding: 2px 4px; width: 220px;" class="form-control">
                    </select>--%>
                </div>
                <div class="form-group">
                ...
                <button id="btnApply" type="button" class="btn btn-custon-four btn-success btn-new-cases" onclick="callCompletedSlotTime()">
                    &nbsp;Apply
                </button>
            </div>
...
<script src="../scripts/hourlyCompletedCases.js?t=<%=DateTime.Now.Ticks%>"></script>
</html>

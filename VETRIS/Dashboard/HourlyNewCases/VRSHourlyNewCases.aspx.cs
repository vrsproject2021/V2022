...
namespace VETRIS.Dashboard.HourlyNewCases
{
    [AjaxPro.AjaxNamespace("VRSHourlyNewCases")]
    public partial class VRSHourlyNewCases : System.Web.UI.Page
    {
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSHourlyNewCases));
            SetPageValue();
        }
        ...
        public LineData SearchRecord(string[] arrRecord)
        {
            ...
            try
            {
                ...
                bReturn = objCore.SearchLineChartNewCases(Server.MapPath("~"), ref ds, ref strCatchMessage);

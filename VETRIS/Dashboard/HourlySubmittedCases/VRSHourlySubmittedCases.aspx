<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSHourlySubmittedCases.aspx.cs" Inherits="VETRIS.Dashboard.HourlySubmittedCases.VRSHourlySubmittedCases" %>
...
<head runat="server">
    <title>Hourly Submitted Cases</title>
    <!-- Google Fonts
		============================================ -->
        ...
        <header style="margin-top: 5px;">
            <div class="form-inline mt-2">
                ...
                <div class="form-group">
                    ...
                    <select id="tp" style="padding: 2px 4px; width: 60px;" class="form-control">
...
<script src="../scripts/hourlySubmittedCases.js?t=<%=DateTime.Now.Ticks%>"></script>
</html>

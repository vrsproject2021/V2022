<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DICOMUploader.ascx.cs" Inherits="VETRIS.CaseList.DICOMUploader" %>
<meta charset="utf-8" />
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <div class="col-sm-12 col-xs-12 margin-bottom-10 margin-top-10">
                    ...
                    <asp:Label ID="lblHelpStartDCM" runat="server" Font-Italic="True" Text="DICOM" Font-Size="Smaller"></asp:Label>
    ...
    $(document).ready($(function () {
        ...
        $("#fUpload").on('change', function (evt) {
            ...
            if (size <= (100*1024*1024)) {
                ...
                xhr.open("POST", "DICOMUploadHandler.ashx");
                ...
                parent.parent.PopupMessage(objhdnRootDirectory.value, "DICOMUploader", "DICOM Upload", "332", "true", size_upld.toString());
                $("#fUpload").val('');
            }
            evt.preventDefault();
        });

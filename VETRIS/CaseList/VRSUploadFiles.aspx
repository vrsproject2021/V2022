...
<body style="background-color:transparent;">
    <form id="form1" runat="server">
        <div style="padding:10px;" class="userControl">
            <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12 margin-bottom-10 margin-top-10">
                                    ...
                                    <asp:Label ID="lblUploadHelpImg" runat="server" Font-Italic="True" Text=" .JPG/.JPEG,.GIF,.PNG,.BMP" Font-Size="Smaller"></asp:Label>
                                    <asp:Label ID="lblUploadHelpSize" runat="server" Font-Italic="True" Text="&nbsp;format supported. Maximum 100.00 MB" Font-Size="Smaller"></asp:Label>
                                    <asp:Label ID="lblUploadHelpEnd" runat="server" Font-Italic="True" Text="&nbsp;of File Size Allowed]" Font-Size="Smaller"></asp:Label>
                                </div>

                                <div class="col-sm-10 col-xs-10 marginMobileTP10">
                                    <asp:FileUpload ID="flUpload" runat="server" Height="22px" CssClass="fUploader" Width="100%" ValidateRequestMode="Disabled" />
                                </div>

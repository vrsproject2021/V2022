...
{
    [AjaxPro.AjaxNamespace("VRSDownloadMultipleStudyImg")]
    public partial class VRSDownloadMultipleStudyImg : System.Web.UI.Page
    {
        ...
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(VRSDownloadMultipleStudyImg));
            SetPageValue();
            SetAttributes();
        }
        #endregion
            ...
            try
            {
                ...
                if (bReturn)
                {
                    if (objCore.STUDY_UID != string.Empty)
                    {
                        ...
                        hdnFolderName.Value = objCore.INSTITUTION_CODE + "_" + objCore.INSTITUTION_NAME;
                        hdnArchFolderPath.Value = objCore.PACS_ARCHIVE_FOLDER;
                        hdnArchAltFolderPath.Value = objCore.PACS_ARCHIVE_ALTERNATE_FOLDER;
        ...
        [AjaxPro.AjaxMethod()]
        public string[] CopyFolder(string[] ArrParams, string[] ArrSUID)
        {
            bool bReturn = true;
            string strSUID = string.Empty;
            string[] arrRet = new string[0];
            string strArchFolder = string.Empty;
            string strArchFolderAlt = string.Empty;
            string strArchFolderName = string.Empty;
            string strArchSYFolderName = string.Empty;
            string strArchFolderPath = string.Empty;
            string strArchFolderAltPath = string.Empty;
            ...
            try
            {
                strArchFolder = ArrParams[0].Trim();
                strArchFolderAlt = ArrParams[1].Trim();
                strArchFolderName = ArrParams[2].Trim();
                strTgtFolderName = ArrParams[3].Trim();
                strDCMMODIFYEXEPATH = ArrParams[4].Trim();
                strVWINSTINFO = ArrParams[5].Trim();
                strInstCode = ArrParams[6];
                strSuffix = ArrParams[7];
                strUserID = ArrParams[8].Trim();
                ...
                for (int x = 0; x < ArrSUID.Length; x = x + 2)
                {
                    strSUID = ArrSUID[x];
                    strPhysCode = ArrSUID[x + 1];

                    strArchSYFolderName = strArchFolderName + "_" + strSUID;
                    strArchFolderPath = strArchFolder + "/" + strArchSYFolderName;
                    strArchFolderAltPath = strArchFolderAlt + "/" + strArchSYFolderName;
                    ...
                    if (arrFiles.Length > 0)
                    {
                        for (int i = 0; i < arrFiles.Length; i++)
                        {
                            ...
                            strNewFileName = strInstCode + "_" + strSuffix + "_" + intSrl.ToString();
                    ...
                    #region Files In Alternate Archive Path

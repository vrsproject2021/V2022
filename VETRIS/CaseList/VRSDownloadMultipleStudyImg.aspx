<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSDownloadMultipleStudyImg.aspx.cs" Inherits="VETRIS.CaseList.VRSDownloadMultipleStudyImg" %>
...
<body>
    <form id="form1" runat="server">
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <input type="hidden" id="hdnFolderName" runat="server" value="" />
...
<script type="text/javascript">
    ...
    var objhdnFolderName = document.getElementById('<%=hdnFolderName.ClientID %>');
    ...
    var strForm = "VRSDownloadMultipleStudyImg";
</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="scripts/DownloadMultipleStudyImg.js?v=<%=DateTime.Now.Ticks%>"></script>
</html>

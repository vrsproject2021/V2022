<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSCaseArchiveBrw.aspx.cs" Inherits="VETRIS.CaseList.VRSCaseArchiveBrw" %>
...
<head runat="server">
    ...
    <script src="scripts/CaseArchiveBrwHdr.js?v=<%=DateTime.Now.Ticks%>"></script>
</head>
<body>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="searchSection searchPart" id="searchSection" style="display: none; position: fixed; z-index: 999; background: #fff;">
                <div>
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-xs-12" id="divRadiologist" style="display: none;margin-top: 10px;">
                            <div class="form-select-list">
                                <label class="control-label">Radiologist</label>
                                <asp:DropDownList ID="ddlRadiologist" runat="server" CssClass="form-control custom-select-value"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="row" id="divRptReason1">
                        <div class="col-sm-3">
                    ...
                    <div class="row" id="divRptReason2">
                        <div class="col-sm-3">
                            <div class="optSwitch pull-left">
                               &nbsp;
                            </div>
                        </div>
                        <div class="col-sm-9 col-xs-12 marginMobileTP10">
                             <div class="form-select-list">
                                    ...
                                    <ComponentArt:Grid
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn Align="center" HeadingText=" " AllowGrouping="false" DataCellClientTemplateId="RADACTION" FixedWidth="True" Width="70" Visible="false" />
                                                    ...
                                                    <ComponentArt:GridColumn DataField="received_via_dicom_router" Align="center" HeadingText="received_via_dicom_router" AllowGrouping="false" Visible="false" />
                                        ...
                                        <ClientTemplates>
                                            ...
                                            <ComponentArt:ClientTemplate ID="ACTION">
                                                ...
                                                <button type="button" id="btnRpt_## DataItem.GetMember('id').Value ##" class="btn btn-success btn_grd" title="Final Report" onclick="javascript:btnRpt_OnClick('## DataItem.GetMember('id').Value ##','## DataItem.GetMember('study_uid').Value ##','## DataItem.GetMember('PACSRPTVWRURL').Value ##','## DataItem.GetMember('patient_name').Value ##','## DataItem.GetMember('custom_report').Value ##');">
                                                ...
                                                <button type="button" id="btnFwd_## DataItem.GetMember('id').Value ##" class="btn btn-info btn_grd" title="Forward report & image links" onclick="javascript:btnFwd_OnClick('## DataItem.GetMember('id').Value ##','## DataItem.GetMember('study_uid').Value ##');">
                                            ...
                                            <ComponentArt:ClientTemplate ID="RADACTION">
                                               <button type="button" id="btnEditRpt_## DataItem.GetMember('id').Value ##" class="btn btn-success btn_grd" title="click to view/add addendum the report" onclick="javascript:btnEditRpt_OnClick('## DataItem.GetMember('id').Value ##');">
...
<script type="text/javascript">
    ...
    var strForm = "VRSCaseArchiveBrw";

</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="../scripts/AppPages.js?25052020"></script>
<script src="scripts/CaseArchiveBrw.js?v=<%=DateTime.Now.Ticks%>"></script>
</html>

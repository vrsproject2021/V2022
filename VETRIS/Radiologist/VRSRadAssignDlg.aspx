<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSRadAssignDlg.aspx.cs" Inherits="VETRIS.Radiologist.VRSRadAssignDlg" %>
...
<head runat="server">
    ...
    <script src="scripts/RadAssignDlgHdr.js?15042020"></script>
</head>
<body>
                            ...
                            <div class="row marginTP10">
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <%--  <div class="pull-left grid_option customRadio">
                                        <asp:RadioButton ID="rdoEligible" runat="server" GroupName="grpRad" />
                                        <label for="rdoEligible" class="label-default" style="width: auto; margin-top: 10px;"></label>
                                    </div>
                                    <span class="pull-left" style="padding-left: 0; padding-top: 5px; padding-right: 2px;">Scheduled & Eligible</span>--%>
                                </div>
                                <div class="col-sm-6 col-xs-12">
...
<script src="scripts/RadAssignDlg.js?v=<%=DateTime.Now.Ticks%>"></script>

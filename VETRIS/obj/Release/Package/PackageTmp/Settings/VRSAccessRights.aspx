...
<head runat="server">
    ...
    <script src="../scripts/jquery-1.7.1.js"></script>
     <script src="scripts/AccessRightsHdr.js" type="text/javascript"></script>
</head>
<body>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12" style="height: 360px; overflow-x: auto; overflow-y:auto;">
                                    <ComponentArt:CallBack ID="CallBackUserRole" runat="server" OnCallback="CallBackUserRole_Callback">
                                            <Content>
                                                <div id="divUserRole" runat="server" style="width: 100%; height:350px; overflow: auto; border: solid 1px #bbb;">
                                                    <ComponentArt:TreeView ID="tvUserRoles"
                                                        DragAndDropEnabled="false"
                                                        DragAndDropAcrossTreesEnabled="false"
                                                        NodeEditingEnabled="false"
                                                        AutoTheming="true" CssClass="TreeView2" EnableTheming="True"
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12" style="height: 360px; overflow-x: auto; overflow-y:auto;">
                                    <ComponentArt:CallBack ID="CallBackRights" runat="server" OnCallback="CallBackRights_Callback">
                                            <Content>
                                                <div id="divRights" runat="server" style="width: 100%; height: 350px; overflow: auto; border: solid 1px #bbb;">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12" style="height: 360px; overflow-x: auto; overflow-y:auto;">
                                   <ComponentArt:CallBack ID="CallBackAssign" runat="server" OnCallback="CallBackAssign_Callback">
                                            <Content>
                                                <div id="divAssigned" runat="server" style="width: 100%; height: 350px; overflow: auto; border: solid 1px #bbb;">

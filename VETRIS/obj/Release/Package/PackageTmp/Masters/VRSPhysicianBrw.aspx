<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSPhysicianBrw.aspx.cs" Inherits="VETRIS.Masters.VRSPhysicianBrw" %>
...
<head runat="server">
    ...
    <script src="scripts/PhysicianBrwHdr.js"></script>
</head>
<body>
                ...
                <div class="sparkline10-hd">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12 text-right">
                            ...
                            <button type="button" id="btnAdd" runat="server" class="btn btn-custon-four btn-primary" style="display:none;">
...
<script type="text/javascript">
    ...
    var strForm = "VRSPhysicianBrw";

</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="../scripts/AppPages.js?2"></script>
<script src="scripts/PhysicianBrw.js"></script>
</html>

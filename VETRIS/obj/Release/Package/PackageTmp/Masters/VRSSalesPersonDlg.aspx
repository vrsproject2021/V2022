                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtPwd" runat="server" CssClass="form-control" MaxLength="200"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-sm-3 col-xs-12">
                            <div class="form-select-list">
                        ...
                        <div class="col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtPACSPwd" runat="server" CssClass="form-control" MaxLength="200"></asp:TextBox>
                            </div>
                        </div>
...
<script src="scripts/SalesPersonDlg.js?27052019"></script>
</html>

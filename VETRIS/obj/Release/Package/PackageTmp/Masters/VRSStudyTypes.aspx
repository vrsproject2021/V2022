...
<head runat="server">
    ...
    <script src="scripts/StudyTypesHdr.js"></script>
    <title></title>
</head>
<body>
                                    ...
                                    <ComponentArt:Grid
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="modality_id" Align="left" HeadingText="Modality" AllowGrouping="true" DataCellClientTemplateId="MODALITY" FixedWidth="True" Width="200" />
                                        ...
                                        <ClientTemplates>
                                            ...
                                            <ComponentArt:ClientTemplate ID="MODALITY">
                                                <select id="ddlModality_## DataItem.GetMember('rec_id').Value ##" class="form-control custom-select-value" style="width: 95%;" onchange="javascript:ddlModality_OnChange('## DataItem.GetMember('rec_id').Value ##');">
                                                </select>
...
<script src="scripts/StudyTypes.js"></script>
</html>

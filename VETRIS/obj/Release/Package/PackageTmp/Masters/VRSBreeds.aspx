<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VRSBreeds.aspx.cs" Inherits="VETRIS.Masters.VRSBreeds" %>
...
<head runat="server">
    ...
    <script src="scripts/BreedsHdr.js"></script>
</head>
<body>
    <form id="form1" runat="server">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="searchSection searchPart" id="searchSection" style="display: none; position: fixed; z-index: 999; background: #fff;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-xs-12 marginMobileTP10">
                                <div class="form-group">
                                    <label class="control-label" for="username">Species</label>
                                    ...
                                    <ComponentArt:Grid
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="species_id" Align="left" HeadingText="Species" AllowGrouping="true" DataCellClientTemplateId="SPECIES" FixedWidth="True" Width="150" />
                                        ...
                                        <ClientTemplates>
                                            ...
                                            <ComponentArt:ClientTemplate ID="SPECIES">
                                                <select id="ddlSpecies_## DataItem.GetMember('rec_id').Value ##" class="form-control custom-select-value" style="width: 95%;" onchange="javascript:ddlSpecies_OnChange('## DataItem.GetMember('rec_id').Value ##');">
                                                </select>
        ...
        <input type="hidden" id="hdnSpecies" runat="server" value="" />
    </form>
</body>
<script type="text/javascript">
    ...
    var objhdnSpecies = document.getElementById('<%=hdnSpecies.ClientID %>');
    var strForm = "VRSBreeds";

</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="../scripts/AppPages.js"></script>
<script src="scripts/Breeds.js"></script>
</html>

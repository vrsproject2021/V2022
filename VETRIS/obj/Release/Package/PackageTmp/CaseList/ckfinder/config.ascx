...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        BaseUrl = ConfigurationManager.AppSettings["ServerPath"]+ "Parameters/";
            //.Replace("ckfinder\\core\\connector\\Parameters\\", "");

		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = Server.MapPath("../Parameters/").Replace("ckfinder\\core\\connector\\Parameters\\", "");

...
<head runat="server">
    ...
    <script src="scripts/CaseArchiveBrwHdr.js"></script>
</head>
<body>
                                    ...
                                    <ComponentArt:Grid
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="PACMAILRPTURL" Align="left" HeadingText="PACSRPTVWRURL" AllowGrouping="false" Visible="false" />
                                        ...
                                        <ClientTemplates>
                                            ...
                                            <ComponentArt:ClientTemplate ID="ACTION">
                                                ...
                                                <button type="button" id="btnRpt_## DataItem.GetMember('id').Value ##" class="btn btn-success btn_grd" title="click to view the final report" onclick="javascript:btnRpt_OnClick('## DataItem.GetMember('id').Value ##','## DataItem.GetMember('PACMAILRPTURL').Value ##');">
                                                    <i class="fa fa-file-text-o" aria-hidden="true"></i>
                                                </button>
                                                <button type="button" id="btnImg_## DataItem.GetMember('id').Value ##" class="btn btn-warning btn_grd" title="click to view the study image(s)" onclick="javascript:btnImg_OnClick('## DataItem.GetMember('id').Value ##','## DataItem.GetMember('PACIMGVWRURL').Value ##');">
...
<script src="scripts/CaseArchiveBrw.js"></script>
</html>

...
<head runat="server">
    ...
    <script src="scripts/InProgressBrwHdr.js"></script>
</head>
<body>
            ...
            <div class="searchSection searchPart" id="searchSection" style="display: none; position: fixed; z-index: 999; background: #fff;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 marginMobileTP10">
                                <div class="form-select-list">
                                    &nbsp;
                                    <asp:TextBox ID="txtRadiologist" runat="server" CssClass="form-control" MaxLength="250" style="display:none;"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                        ...
                                        <Levels>
                                            <ComponentArt:GridLevel
                                                ...
                                                <Columns>
                                                    ...
                                                    <ComponentArt:GridColumn DataField="radiologist" Align="left" HeadingText="Reader" AllowGrouping="false" DataCellClientTemplateId="RADIOLOGIST" FixedWidth="True" Width="120" Visible="false" />
...
<script type="text/javascript">
    ...
    var objtxtRadiologist = document.getElementById('<%=txtRadiologist.ClientID %>');
    var strForm = "VRSInProgressBrw";

</script>
<script src="../scripts/custome-javascript.js"></script>
<script src="../scripts/AppPages.js?1"></script>
<script src="scripts/InProgressBrw.js?2"></script>
</html>

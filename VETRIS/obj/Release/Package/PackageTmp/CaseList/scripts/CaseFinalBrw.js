...
function SetFilterValues() {
    if (parent.GsFilter.length > 0) {
        ...
        objddlPhys.value = parent.GsFilter[9];
    }
    else
...
function PreserveFilterValues() {
    ...
    parent.GsFilter[9] = parent.Trim(objddlPhys.value);
}
...
function ddlSpecies_OnChange() {
    ...
    try {
        ...
        VRSCaseFinalBrw.FetchBreeds(ArrRecords, ShowProcess);
    }
    catch (expErr) {
        parent.HideProcess();

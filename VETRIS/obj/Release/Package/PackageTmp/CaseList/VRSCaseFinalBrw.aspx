...
<head runat="server">
    ...
    <script src="scripts/CaseFinalBrwHdr.js"></script>
</head>
<body>
                                    ...
                                    <ComponentArt:Grid
                                        ...
                                        <ClientTemplates>
                                            ...
                                            <ComponentArt:ClientTemplate ID="ACTION">
                                                ...
                                                <button type="button" id="btnRpt_## DataItem.GetMember('id').Value ##" class="btn btn-success btn_grd" title="Final Report" onclick="javascript:btnRpt_OnClick('## DataItem.GetMember('id').Value ##','## DataItem.GetMember('PACMAILRPTURL').Value ##');">
...
<script src="scripts/CaseFinalBrw.js?1"></script>
</html>

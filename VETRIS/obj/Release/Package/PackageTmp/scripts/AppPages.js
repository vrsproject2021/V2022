var UserID = parent.objhdnUserID.value; var UserName = parent.objhdnUserName.value; var UserRoleID = parent.objhdnUserRoleID.value;
var MenuID = parent.objhdnMenuID.value;  var Divider = parent.objhdnDivider.value; var SecDivider = parent.objhdnSecDivider.value;
var RootDirectory = parent.objhdnRootDirectory.value; var ServerPath = parent.objhdnServerPath.value;
var strValidate = "Y"; var Unlock = "N"; var UI = "00000000-0000-0000-0000-000000000000"; var strLoadPopup = "Y";
var PACSUID = parent.objhdnPACSUID.value; var PACSPwd = parent.objhdnPACSPwd.value;
...
$(document).ready($(function () {
    ...
    parent.HideLoad();
    parent.GsGsNavURL = ""; parent.GsRetStatus = "false"; parent.GsConfirmAction = "";
    ...
    if (URL != null) {
        if (strValidate == "Y") {
            if (parseInt(objhdnID.value) == 0) {
                parent.PopupMessage(RootDirectory, strForm, "btnBrwEdit_Onclick()", "023", "true");
            }
            else {
                ...
                if (URL.indexOf("?") != -1) {
                    if (URL.indexOf("id") != -1)
                        ...
                        parent.objiframePage.src = URL + "&uid=" + UserID + "&urid=" + UserRoleID + "&mid=" + MenuID + "&id=" + objhdnID.value;
                }
                else
                    parent.objiframePage.src = URL + "?uid=" + UserID + "&urid=" + UserRoleID + "&mid=" + MenuID + "&id=" + objhdnID.value;
            }
    ...
    if (URL != null) {
        if (strValidate == "Y") {
            if (objhdnID.value == "00000000-0000-0000-0000-000000000000") {
                parent.PopupMessage(RootDirectory, strForm, "btnBrwEditUI_Onclick()", "023", "true");
            }
            else {
                if(parent.GsIsBrowser == "Y") PreserveFilterValues();
                parent.GsIsBrowser = "N"; parent.GsRetStatus = "false";
...
function btnBrwAdd_Onclick(URL) {
    if (URL != null) {
        ...
        parent.PopupLoad();
        if (URL.indexOf("?") != -1) {
            parent.objiframePage.src = URL + +"&uid=" + UserID + "&urid=" + UserRoleID + "&mid=" + MenuID + "&id=0";
        }
        else
            parent.objiframePage.src = URL + "?uid=" + UserID + "&urid=" + UserRoleID + "&mid=" + MenuID + "&id=0";
    }
...
function btnBrwAddUI_Onclick(URL) {
    if (URL != null) {
        ...
        parent.PopupLoad();
        if (URL.indexOf("?") != -1) {
            parent.objiframePage.src = URL + "&uid=" + UserID + "&urid=" + UserRoleID + "&mid=" + MenuID + "&id=00000000-0000-0000-0000-000000000000";
        }
        else
            parent.objiframePage.src = URL + "?uid=" + UserID + "&urid=" + UserRoleID + "&mid=" + MenuID + "&id=00000000-0000-0000-0000-000000000000";
    }
...
function btnBrwClose_Onclick() {
    ...
    else parent.LoadHome(UserID, UI);
}

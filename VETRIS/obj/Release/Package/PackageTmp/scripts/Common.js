...
var GsRetStatus = "false"; var GsHelpID = ""; var GsText = ""; var GsLogout = "N";
var GcDivider = objhdnDivider.value; var GsFilter = new Array(); var GsConfirmAction = ""; var GsDlgConfAction = ""; var GsStoredValue = new Array();
var GsText = ""; var GsTaskOverdue = "X"; var GsAssignType = "B"; var GsDayRange = ""; var GsStat = "ALL"; var GsApproved = "A"; var GsIsProject = 'N'; var GsIsMDDB = "N";
...
function adjustFrameHeight() {
    ...
    //alert(offsetHeight);
    if (frameDoc.body.offsetHeight > offsetHeight) {
        frame.style.height = frameDoc.body.offsetHeight.toString() + "px";
        //divBody.height = frameDoc.body.offsetHeight + 20;
    }
    else {
        frame.style.height = offsetHeight.toString() + "px";
        ...
        if (regs = strInput.match(re)) {
            if (regs[3]) {
                ...
                if (regs[1] < 1 || regs[1] > 12) {
                    PopupMessage(strRootDirectory, "Common.js", "ValidateTimeInput()", "157", "true", "00-23", "", "TE");
                    return false;
                }
            } else {
            ...
            if (regs[2] > 59) {
                PopupMessage(strRootDirectory, "Common.js", "ValidateTimeInput()", "158", "true", "00-59", "", "TE");
                return false;
            }
        } else {
            PopupMessage(strRootDirectory, "Common.js", "ValidateTimeInput()", "156", "true", "HH:MM", "", "TE");
            return false;
        }
        return true;
    }
